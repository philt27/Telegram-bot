...
def start(update, context):
    ...
    update.message.reply_text('Привет! Я могу прислать тебе картинку или мем небольшого размера, для быстрой пересылки твоим бро! Что бы ты хотел получить?')
...
def help(update, context):
    ...
    update.message.reply_text('🤣 Для получения мема для напиши: мем "пробел" запрос')
